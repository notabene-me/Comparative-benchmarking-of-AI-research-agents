...
METHOD_TERMS: Dict[str, List[str]] = {
    ...
    "normalization":         [r"\bnormali[sz]ation\b"],
...
def build_commonality_difference_summary(
    ...
    rows.append({
        ...
        "interpretation": (
            "Shared biological themes reflect convergent proteomics interpretation. "
    ...
    rows.append({
        "dimension": "Pathway / protein-function interpretation",
        "common_across_agents": "pathway_analysis, GO enrichment, KEGG (if shared)",
        ...
        "interpretation": (
            ...
            "(GO, KEGG, Reactome, STRING) indicates common analytical toolkit."
        ),
        "evidence_table": "consensus_core_terms.csv",
        "evidence_figure": "consensus_biological_theme_heatmap.png",
    })
