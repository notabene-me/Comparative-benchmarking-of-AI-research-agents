...
Or headlessly (just run the pipeline):
    python app.py --input_dir ./agent_outputs_proteomics --output_dir ./benchmark_results_proteomics
"""
...
def run_streamlit_app() -> None:
    ...
    st.markdown(
        ...
        "untargeted proteomics dataset across 8 independent runs."
    )

    # Sidebar configuration
    with st.sidebar:
        st.header("Configuration")
        input_dir  = st.text_input("Input directory",  value="./agent_outputs_proteomics")
        output_dir = st.text_input("Output directory", value="./benchmark_results_proteomics")
