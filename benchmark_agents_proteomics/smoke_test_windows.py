#!/usr/bin/env python3
"""
smoke_test_windows.py — minimal environment and folder smoke test (proteomics).

Run from the proteomics project root:
...
def main() -> int:
    ...
    print("macOS:  python main.py --input_dir ./agent_outputs_proteomics \\")
    print("          --output_dir ./benchmark_results_proteomics --n_mc 10000")
