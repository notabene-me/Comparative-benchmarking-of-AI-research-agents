#!/usr/bin/env python3
"""
smoke_test_windows.py — minimal environment and folder smoke test (transcriptomics).

Run from the transcriptomics project root:
...
def main() -> int:
    ...
    print("\n=== Smoke test: transcriptomics folders ===")
    ...
    print("macOS:  python main.py --input_dir ./agent_outputs_transcriptomics \\")
    print("          --output_dir ./benchmark_results_transcriptomics --n_mc 10000")
