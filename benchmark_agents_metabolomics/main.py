...
Usage:
    ...
    python main.py --input_dir ./agent_outputs_metabolomics \\
        --output_dir ./benchmark_results_metabolomics \\
    ...
    python main.py --generate_demo --input_dir ./agent_outputs_metabolomics
"""
...
def parse_args(argv=None):
    p = argparse.ArgumentParser(
        description="AI Agent Benchmark — untargeted metabolomics comparison pipeline",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    p.add_argument("--input_dir",  default="./agent_outputs_metabolomics",
                   help="Root directory containing agent output files.")
    p.add_argument("--output_dir", default="./benchmark_results_metabolomics",
...
def run_pipeline(args) -> None:
    ...
    _save_csv(domain_scores,    tables_dir / "domain_metabolomics_score_components.csv","domain components")
    ...
    audit_bundle = {
        ...
        "domain_metabolomics_score_components": domain_scores,
...
def _create_demo_data(input_dir: Path) -> None:
    ...
    agents = ["ChatGPT", "Biomni", "KDense"]
    n_runs = 8

    METABOLOMICS_PHRASES = [
        "Untargeted metabolomics analysis was performed using LC-MS/MS.",
        ...
        "PLS-DA was applied to identify discriminant metabolites.",
        ...
        "A total of 342 metabolites were identified using HMDB.",
        "Pathway analysis was conducted via KEGG pathway enrichment.",
        "Fold change > 2 and FDR < 0.05 were applied as significance thresholds.",
        "Volcano plot visualization revealed 56 significantly altered metabolites.",
        "Amino acid metabolism and TCA cycle pathways were significantly enriched.",
        "Batch correction was applied using ComBat algorithm.",
        "Log2 fold change (log2FC) was calculated for all metabolites.",
        "Results were visualised as a heatmap of the top 50 features.",
        "The HILIC column was used for polar metabolite separation.",
        "MetaboAnalyst was used for pathway enrichment analysis.",
        "Oxidative stress markers were elevated in the disease group.",
    ...
    for agent in agents:
        for run_num in range(1, n_runs + 1):
            ...
            writer.writerow(["metabolite", "pvalue", "fdr", "log2fc", "significant"])
            for i in range(random.randint(10, 30)):
                ...
                writer.writerow([f"HMDB{i+1:05d}", pval, fdr, fc, sig])
