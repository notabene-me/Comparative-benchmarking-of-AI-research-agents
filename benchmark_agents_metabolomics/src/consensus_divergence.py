...
BIO_TERMS: Dict[str, List[str]] = {
    "amino_acids":             [r"\bamino\s+acid[s]?\b"],
    "lipids":                  [r"\blipid[s]?\b"],
    "phospholipids":           [r"\bphospholipid[s]?\b"],
    "sphingolipids":           [r"\bsphingolipid[s]?\b"],
    "ceramides":               [r"\bceramide[s]?\b"],
    "carnitines":              [r"\bcarnitine[s]?\b"],
    "nucleotides":             [r"\bnucleotide[s]?\b"],
    "purines":                 [r"\bpurine[s]?\b"],
    "pyrimidines":             [r"\bpyrimidine[s]?\b"],
    "taurine":                 [r"\btaurine\b"],
    "glutathione":             [r"\bglutathione\b"],
    "oxidative_stress":        [r"\boxidative\s+stress\b"],
    "energy_metabolism":       [r"\benergy\s+metabolism\b"],
    "mitochondrial_metabolism":[r"\bmitochondrial\s+(metabolism|function)\b"],
    "inflammation":            [r"\binflammation\b", r"\binflammatory\b"],
    "membrane_remodeling":     [r"\bmembrane\s+(remodel|reorgani|composit)"],
    "pathway_enrichment":      [r"\bpathway\s+enrichment\b"],
    "TCA_cycle":               [r"\bTCA\s+cycle\b", r"\bKrebs\s+cycle\b"],
    "fatty_acids":             [r"\bfatty\s+acid[s]?\b"],
...
def build_commonality_difference_summary(
    ...
    rows.append({
        ...
        "interpretation": (
            "Shared biological themes reflect convergent metabolomics interpretation. "
    ...
    rows.append({
        "dimension": "Pathway / metabolite-class interpretation",
        "common_across_agents": "pathway_analysis, KEGG (if shared)",
        ...
        "interpretation": (
            ...
            "(KEGG, HMDB) indicates common analytical toolkit."
        ),
        "evidence_table": "consensus_core_terms.csv",
        "evidence_figure": "consensus_biological_theme_heatmap.png",
    })
